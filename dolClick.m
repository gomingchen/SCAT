...
threeDplotfunc_cr_dolphin(A, index(w), des, intvl,intvl_thin, Nbin, ip_L{w}, Sep, Fc);
...
for q = 1:length(long_in)
    ...
    text(min(comp(q)/500+B)+sep-.7, 200, 50, str, 'FontSize', 12, 'FontName', 'times');
end
