...
function ip =  findphantomNotches2(NE, T, fc, ipL, Nch, Nthre)
...
for j = 1:Nthre
    ...
    for i = 1:NE
        ...
        lat_th(i) = Max;
        %%%%%
        plot([Max Max]-mnd+1E3*i, [40, 150]*1E3, 'k', 'LineWidth',1);
        ...
        bar(edges(1:end-1)+(edges(2)-edges(1))/2-mnd+1E3*i, N/max(N)*35E3, 'FaceColor','b','EdgeColor','b');
